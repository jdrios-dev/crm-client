  ...
  return (
    <div className={` ${clase} border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-2 md:gap-4 shadow-lg`}>
      <div>
        ...
        <h2 className='text-gray font-bold mt-10'>Estado Pedido: </h2>

        <select
          className='mt-2 appearance-none bg-blue-500 border border-blue-900 text-white p-2 text-center rounded leading-tight focus:outline-none  focus:bg-blue-600 focus:border-blue-500 uppercase text-xs font-bold'
      ...
      <div>
        <h2 className='text-gray-800 font-bold mt-2'>Resumen del Pedido:</h2>
        {
          pedido.pedido.map(articulo => (
            <div
              ...
              className='mt-4'
            > 
              <p className='text-sm text-gray-500'>Producto: {articulo.nombre} </p>
        ...
        <button
          className="bg-red-600 px-4 py-1 text-white text-xs rounded hover:bg-red-700 inline-block mt-5 flex"
